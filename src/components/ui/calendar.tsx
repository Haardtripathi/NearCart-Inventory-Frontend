  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_button: 'inline-flex h-10 w-10 items-center justify-center rounded-xl text-sm font-medium text-slate-700 transition hover:bg-slate-100 hover:text-slate-900 aria-selected:opacity-100 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-primary/15',
        range_start: 'range-start',
        range_end: 'range-end',
        selected: 'bg-primary text-white hover:bg-primary hover:text-white focus:bg-primary focus:text-white rounded-xl',
        today: 'border border-primary/30 bg-primary/10 text-primary font-semibold',
        outside: 'text-slate-300 opacity-70',
        disabled: 'cursor-not-allowed text-slate-300 opacity-50',
        range_middle: 'aria-selected:bg-primary/10 aria-selected:text-slate-900 rounded-none',
        hidden: 'invisible',
        ...classNames,
      }}
      components={{
