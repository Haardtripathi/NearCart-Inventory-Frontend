...
import { Dialog, DialogContent, DialogDescription, DialogTitle } from '@/components/ui/index'
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex cursor-pointer select-none items-center rounded-md px-2 py-1.5 text-sm text-foreground/80 outline-none',
