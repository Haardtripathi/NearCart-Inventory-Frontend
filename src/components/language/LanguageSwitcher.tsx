...
export function LanguageSwitcher() {
  ...
  return (
    <div className="flex min-w-0 items-center gap-2 rounded-md border border-slate-200 bg-white px-2.5 py-1 shadow-sm sm:min-w-[148px]">
      <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-md bg-slate-100 text-slate-500">
        <Globe2 className="h-4 w-4" />
      </span>
      <OptionSelect
        className="h-8 min-w-0 border-0 bg-transparent px-0 shadow-none focus:border-transparent focus:ring-0"
