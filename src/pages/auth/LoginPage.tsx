  ...
  return (
    <div className="min-h-screen px-4 py-6 sm:px-6 sm:py-8 lg:px-8">
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-6">
        ...
        <div className="relative order-2 overflow-hidden rounded-[2rem] border border-slate-200 bg-white p-6 shadow-[0_24px_55px_rgba(15,23,42,0.08)] sm:p-8 lg:order-1 lg:p-12">
          ...
          <div className="relative">
            ...
            <div className="mt-6 rounded-[1.5rem] border border-emerald-100/70 bg-white/70 p-5">
